...
class SubcategoryResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Subcategorii';

    protected static ?string $modelLabel = 'subcategorie';

    protected static ?string $pluralModelLabel = 'subcategorii';
